...
@Component({
    selector: "changessalon-job-application-thank-you",
    template: `
        ...
        <section class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <div class="text-center"><a class="btn btn-success btn-lg" href="http://changessalon.com">Return to Homepage</a></div>
                </div><!-- /col -->
            </div><!-- /row -->
        </section>
    `,
